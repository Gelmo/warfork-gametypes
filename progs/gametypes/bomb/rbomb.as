...
void bombInit()
{
	...
	@bombMinimap = @G_SpawnEntity( "capture_indicator_minimap" );
	bombMinimap.type = ET_MINIMAP_ICON;
	bombMinimap.solid = SOLID_NOT;
	bombMinimap.frame = 32; // radius
	bombMinimap.modelindex = imgBombMinimap;
	bombMinimap.svflags |= SVF_BROADCAST;
	bombMinimap.svflags &= ~SVF_NOCLIENT;
}
