...
void CTF_SetVoicecommQuickMenu( Client @client )
{
	...
	menuStr += 
		...
		'"Go to warshell" "vsay_team gotowarshell" ' +		
...
{
    gametype.title = "Instagib Capture the Flag";
    ...
    if ( !G_FileExists( "configs/server/gametypes/" + gametype.name + ".cfg" ) )
    {
        ...
        config = "// '" + gametype.title + "' gametype configuration file\n"
                 ...
                 + "\n\n// map rotation\n"
                 + "set g_maplist \"wfctf1 wfctf2 wfctf3 wfctf4 wfctf5 wfctf6\" // list of maps in automatic rotation\n"
