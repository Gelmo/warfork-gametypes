...
bool GT_Command( Client @client, const String &cmdString, const String &argsString, int argc )
{
    ...
    } else if ( cmdString == "callvotevalidate" )
    {
        ...
        if ( votename == "Allow_InstaGib" )
        {
            ...
            if ( voteArg == "0" && !slideAllowInstaGib.boolean )
            {
                client.printMessage( "InstaGib are already disallowed\n" );
                return false;
            }

            if ( voteArg == "1" && slideAllowInstaGib.boolean )
            {
                client.printMessage( "InstaGib are already allowed\n" );
                return false;
            }
        ...
        if ( votename == "Only_InstaGib" )
        {
            ...
            if ( voteArg == "0" && !slideOnlyInstaGib.boolean )
            {
                client.printMessage( "InstaGib are already disallowed\n" );
                return false;
            }

            if ( voteArg == "1" && slideOnlyInstaGib.boolean )
            {
                client.printMessage( "InstaGib are already allowed\n" );
                return false;
            }
...
void GT_InitGametype()
{
    ...
    if ( !G_FileExists( "configs/server/gametypes/" + gametype.name + ".cfg" ) )
    {
        ...
        config = "// '" + gametype.title + "' gametype configuration file\n"
                 ...
                 + "\n\n// map rotation\n"
                 + "set g_maplist \"slide_arena_remix bipbeta2\" // list of maps in automatic rotation\n"
    ...
    gametype.megahealthRespawn = 10;
    gametype.ultrahealthRespawn = 10;
